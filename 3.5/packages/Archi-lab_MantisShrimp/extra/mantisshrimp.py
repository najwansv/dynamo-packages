...
msPath = appDataPath + r"\Dynamo\Dynamo Revit\1.3\packages\Archi-lab_MantisShrimp\extra"
if msPath not in sys.path:
        sys.path.Add(msPath)
txtFilePath = appDataPath + r"\Dynamo\Dynamo Revit\1.3\packages\Archi-lab_MantisShrimp\extra\rhPath.txt"
